...
<html>
    ...
    <body>
        ...
        <div id="show-coordinador" class="content scaffold-show" role="main">
            ...
            <f:display bean="coordinador" />
            <g:form resource="${this.coordinador}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.coordinador}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
